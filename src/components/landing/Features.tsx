...
const features: Feature[] = [
  {
    ...
    description:
      "Mark episodes as you go. Never lose your place in a series again",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "Hours, genres, completion rates — understand your taste in data.",
  },
  {
    id: 4,
...
const FeatureCard = ({
  ...
  return (
    <div className="border border-raised bg-deep rounded-xl p-4">
      <div
        className={`rounded-lg ${iconBg} w-8 h-8 flex items-center justify-center mb-3`}
      >
        {icon}
      </div>
  ...
  return (
    <div>
      <div className="text-center my-8">
        <p className="uppercase text-muted text-xs tracking-widest mb-2">
          Features
        </p>
        <h2 className="text-lg md:text-xl font-bold text-primary">
          Everything Letterboxd isn&apos;t
        </h2>
      </div>
      {/* features grid */}
