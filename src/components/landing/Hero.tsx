      ...
      <div className="flex justify-center">
        <div>
          <div className="flex justify-center mb-4">
            <span className="rounded-full border border-violet/30 bg-violet/15 px-3 py-1 text-violet text-sm font-medium">
          ...
          <p className="text-sm md:text-base max-w-md mx-auto text-center text-muted mb-4">
            Track what you&apos;ve watched, discover what&apos;s next, and see
            what your friends are into — all in one place.
          </p>
            ...
            <div className="flex">
              ...
              <div>
                <p className="text-sm text-muted">
                  Joined by{" "}
                  <span className="font-bold text-primary">2,400+</span> movie
                  lovers this month
                </p>
              </div>
            </div>
